...
| 2 | 사이드바 | 목업에 **「업무 메뉴」 상위 라벨이 없다**. 로고가 **좌측 정렬**(padding 20px)인데 앱은 `SS_CENTER` 가로 중앙. 그룹 라벨 letter-spacing 0.06em | 등재 |
...
| 4 | 헤더 내용 | 제목 옆 **「문서 생성」 보조 라벨**, admin 뒤 **「관리자」 pill**(`#F2EEE7`/`#E4DFD7`/999px/11px 600/`#9A6B3F`) | 등재 |
