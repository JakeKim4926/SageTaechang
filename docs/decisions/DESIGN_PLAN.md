...
| `TAECHANG_COLOR_PILL_BG` | `RGB(247,242,234)` | 실행 기록 필터 pill 배경 (`#F7F2EA`). 테두리·텍스트는 `PRIMARY` 재사용 |
...
- 3-5 `전체 12`·`성공 11`·`실패 1` — **pill 필터 칩** (h28, radius 999, `PILL_BG` 배경, `PRIMARY` 테두리·텍스트, 12px SemiBold). 요약이 아니라 **필터**다. D7-5 소관
