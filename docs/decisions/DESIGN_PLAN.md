...
| D7 | 화면별 적용 — 3장 9세트 | **진행 중** — D7-1 · D7-2 · D7-3 · D7-7 · D7-8 · D7-9 완료·확인받음. 다음은 **7-10(다이얼로그 프레임)**, **7-4~7-6은 3-B-4b~4c 뒤**. 7-2·7-3은 **표현만** 맞췄고 화면 구조는 각 절의 *남은 목업 차이* 참조 |
| D7-10 | 다이얼로그 프레임 전환 (7종) | **신설** 2026-08-06 — D7-9에서 잘못 배제했던 상단 밴드를 되살린다 |
