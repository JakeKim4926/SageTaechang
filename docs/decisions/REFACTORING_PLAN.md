...
### 다음 세션에 할 일 (2026-08-07 세션 종료 시점)

> **미검증 커밋 없음. D7-4가 3단계까지 끝났다.**
>
> **4d-3이 떨어뜨린 것이 D7-4 도중 2건 드러났다** — 시작 화면 라벨 · 행 선택 시 생성 버튼.
> 둘 다 「View의 짐을 옮기면서 부르던 쪽·받던 쪽을 안 본」 같은 뿌리다.
> **3-B-5에서 같은 이동을 또 하므로** 착수 전에 `DEBT_LOG` 검증구멍 항목을 읽는다.
>
