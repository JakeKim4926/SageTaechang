...
## 다음 세션 시작점 (2026-08-08)

### 다음 세션에 할 일 (2026-08-08 세션 종료 시점)

> **미검증 커밋 없음. 디자인(D0~D7)과 구조 리팩토링(3-B)이 둘 다 닫혔다.**
> `develop`이 origin보다 **27커밋 앞서 있다** — 푸시는 사용자가 한다.
>
> **다음은 D8(DPI 배율)이고, 지금까지와 성격이 다르다** — 화면 하나가 아니라
> **모든 화면의 좌표에 손대는 작업**이다. 착수 전에 ① 스킬의 「크기 상수는 96dpi 기준
> 논리 픽셀」 절과 ② 상수 참조 지점을 훑고 **범위를 어디까지로 할지 먼저 정한다.**
>
...
| 1 | **D8 DPI 배율** | 디자인·구조 리팩토링이 끝났다 |
| 2 | 남은 등재 항목 | 검색 박스 좌측 칸 · 라운드 코너 R3 · 상태바 · 셸 여백 24 · 「기타 처리」 배지 |
...
| 4 | **D7-4 · D7-5 · D7-6** | **진행 중** — D7-4 1단계 확인받음 · 2단계 완료(**미검증**). 위 *다음 세션에 할 일* 참조 |
| 5 | **3-B-5a · 5b** 사이드바 · 헤더 패널 | View의 남은 워크플로 분기 9곳이 여기서 대부분 사라진다 |
| 6 | D8 DPI 배율 | 디자인 완료 후 |
