...
| 1 | **D7-6** 데이터 관리 좌우 2단 + ↑↓ | **디자인의 마지막 Step이다.** 착수 전 결정 2건이 남아 있다(좌우 2단 구조 · 카드마다 Primary). D7-4가 미뤄둔 **섹션 밴드 정리 2곳**도 여기서 끝난다 |
| 2 | **3-B-5a · 5b** (사이드바 · 헤더 패널) | View의 남은 워크플로 분기 9곳이 여기서 대부분 사라진다. **이동 전후로 통지 소비자를 대조한다** |
