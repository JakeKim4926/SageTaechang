...
### 지금 어디인가 — **디자인에서 지금 할 수 있는 것은 다 했다. 다음은 3-B-4b~4d**
...
(위 *D7은 대상에 따라 순서가 갈린다*). **따라서 다음 작업은 3-B-4b~4d 패널 분리다.**
...
| 3 | **3-B-4b~4d** 남은 패널 분리 | **다음.** 아래 *4a가 남긴 것*. 여기서 핸들러 정책 술어 4개가 View를 떠나고, **D7-4~D7-6의 막힘도 풀린다** |
...
| 7-4 | `SageTaechangView`(입력 탭) **→ 3-B-4b 이후 `SageWorkflowInputPanel`** | 3-B-4b 뒤 |
