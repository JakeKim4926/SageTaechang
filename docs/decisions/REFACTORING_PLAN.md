...
| 순서 | 할 일 | 근거 |
|---|---|---|
| ~~1~~ | ~~D7-4 (1·2·3단계)~~ | **완료** 2026-08-07 · 확인받음. `CSageStatusCard` 신설 + 4d-3 회귀 2건 회수 |
| ~~2~~ | ~~D7-5 (표 전환 · 필터 pill)~~ | **완료** 2026-08-07 · 확인받음. `CSageFilterPillBar` 신설 · 폭 배분을 core로 · 핸들러 메서드 1개 축소 |
| ~~3~~ | ~~D7-6 (좌우 2단 · ↑↓)~~ | **완료** 2026-08-08 · 확인받음. `CSageSearchBox` 신설 · 순서 교환을 트랜잭션으로 · **D7이 닫혔다** |
| 1 | **3-B-5a · 5b** (사이드바 · 헤더 패널) | View의 남은 워크플로 분기 9곳이 여기서 대부분 사라진다. **이동 전후로 통지 소비자를 대조한다** |
| 2 | D8 DPI 배율 | 디자인 완료 후 |
