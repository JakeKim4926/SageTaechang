...
BEGIN_MESSAGE_MAP(TaechangLoginDlg, SageFramelessDialog)
    ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
...
INT_PTR TaechangLoginDlg::DoModal() {
    BYTE* pTemplate = BuildFramelessTemplate(TAECHANG_UI_LOGIN_DLG_TITLE,
...
BOOL TaechangLoginDlg::OnInitDialog() {
    ...
    CreateControls();
    ApplyFont();
    SizeFramelessClient(TAECHANG_LOGIN_DLG_WIDTH, LayoutControls());
