...
class SageCalcCompanyPickerDlg : public SageFramelessDialog {
public:
    SageCalcCompanyPickerDlg(const CStringArray& arrNames, const CString& strInitialName, CWnd* pParent = NULL);
    ~SageCalcCompanyPickerDlg();
