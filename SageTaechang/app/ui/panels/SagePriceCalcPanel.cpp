...
void SagePriceCalcPanel::CreateControls() {
	...
	m_wndHistoryList.InsertColumn(0, TAECHANG_UI_CALC_HIST_COL_COMPANY, LVCFMT_LEFT, TAECHANG_CALC_HIST_COL_COMPANY_W);
	m_wndHistoryList.InsertColumn(1, TAECHANG_UI_CALC_HIST_COL_ITEM, LVCFMT_LEFT, TAECHANG_CALC_HIST_COL_ITEM_W);
	m_wndHistoryList.InsertColumn(2, TAECHANG_UI_CALC_HIST_COL_DATE, LVCFMT_LEFT, TAECHANG_CALC_HIST_COL_DATE_W);
	m_wndHistoryList.InsertColumn(3, TAECHANG_UI_CALC_HIST_COL_COPIES, LVCFMT_RIGHT, TAECHANG_CALC_HIST_COL_COPIES_W);
	m_wndHistoryList.InsertColumn(4, TAECHANG_UI_CALC_HIST_COL_PAGES, LVCFMT_RIGHT, TAECHANG_CALC_HIST_COL_PAGES_W);
	m_wndHistoryList.InsertColumn(5, TAECHANG_UI_CALC_HIST_COL_PRINT, LVCFMT_RIGHT, TAECHANG_CALC_HIST_COL_PRINT_W);
	m_wndHistoryList.InsertColumn(6, TAECHANG_UI_CALC_HIST_COL_COVER, LVCFMT_RIGHT, TAECHANG_CALC_HIST_COL_COVER_W);
	m_wndHistoryList.InsertColumn(7, TAECHANG_UI_CALC_HIST_COL_FREIGHT, LVCFMT_RIGHT, TAECHANG_CALC_HIST_COL_FREIGHT_W);
	m_wndHistoryList.InsertColumn(8, TAECHANG_UI_CALC_HIST_COL_TOTAL, LVCFMT_RIGHT, TAECHANG_CALC_HIST_COL_TOTAL_W);
	m_wndHistoryList.InsertColumn(9, TAECHANG_UI_CALC_HIST_COL_TIME, LVCFMT_LEFT, TAECHANG_CALC_HIST_COL_TIME_W);
