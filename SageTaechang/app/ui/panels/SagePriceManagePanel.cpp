...
void SagePriceManagePanel::CreateControls() {
	...
	m_wndCopiesList.SetCenterFirstColumn(TRUE);
	m_wndCopiesList.SetExtendedStyle(LVS_EX_FULLROWSELECT | LVS_EX_DOUBLEBUFFER | LVS_EX_GRIDLINES);
...
void SagePriceManagePanel::LayoutChildControls(int nWidth, int nHeight) {
	...
	m_wndCompanyLabel.MoveWindow(nInnerLeft - TAECHANG_PRICE_COMPANY_LABEL_SHIFT,
	...
	m_wndAddCompanyBtn.MoveWindow(nBtnX, nY - TAECHANG_BUTTON_VERT_ADJUST, TAECHANG_BUTTON_WIDTH, TAECHANG_BUTTON_HEIGHT);
	nBtnX += TAECHANG_BUTTON_WIDTH + TAECHANG_ROW_GAP;
	m_wndAddBtn.MoveWindow(nBtnX, nY - TAECHANG_BUTTON_VERT_ADJUST, TAECHANG_BUTTON_WIDTH, TAECHANG_BUTTON_HEIGHT);
	nBtnX += TAECHANG_BUTTON_WIDTH + TAECHANG_ROW_GAP;
	m_wndRenameCompanyBtn.MoveWindow(nBtnX, nY - TAECHANG_BUTTON_VERT_ADJUST, TAECHANG_BUTTON_WIDTH, TAECHANG_BUTTON_HEIGHT);
	nBtnX += TAECHANG_BUTTON_WIDTH + TAECHANG_ROW_GAP;
	m_wndDeleteCompanyBtn.MoveWindow(nBtnX, nY - TAECHANG_BUTTON_VERT_ADJUST, TAECHANG_BUTTON_WIDTH, TAECHANG_BUTTON_HEIGHT);
