...
const SageWorkflowColumn g_inputColumns[] = {
	{ TAECHANG_UI_ESTIMATE_COL_ROW, SAGE_COLUMN_ALIGN_LEFT, TAECHANG_ESTIMATE_ROW_WIDTH, FALSE, SAGE_RESULT_FIELD_FIELD },
	{ TAECHANG_UI_ESTIMATE_COL_COMPANY, SAGE_COLUMN_ALIGN_LEFT, TAECHANG_ESTIMATE_COMPANY_WIDTH, FALSE, SAGE_RESULT_FIELD_COMPANY_NAME },
	{ TAECHANG_UI_ESTIMATE_COL_DATE, SAGE_COLUMN_ALIGN_LEFT, TAECHANG_ESTIMATE_DATE_WIDTH, FALSE, SAGE_RESULT_FIELD_ISSUE_DATE },
	{ TAECHANG_UI_ESTIMATE_COL_ITEM, SAGE_COLUMN_ALIGN_LEFT, TAECHANG_ESTIMATE_ITEM_WIDTH, FALSE, SAGE_RESULT_FIELD_ITEM_NAME },
	{ TAECHANG_UI_ESTIMATE_COL_COPIES, SAGE_COLUMN_ALIGN_RIGHT, TAECHANG_ESTIMATE_COPIES_WIDTH, FALSE, SAGE_RESULT_FIELD_COMPANY_COPIES },
	{ TAECHANG_UI_ESTIMATE_COL_PAGES, SAGE_COLUMN_ALIGN_RIGHT, TAECHANG_ESTIMATE_PAGES_WIDTH, FALSE, SAGE_RESULT_FIELD_CORPORATION_COPIES },
	{ TAECHANG_UI_ESTIMATE_COL_UNIT_PRICE, SAGE_COLUMN_ALIGN_RIGHT, TAECHANG_ESTIMATE_UNIT_PRICE_WIDTH, FALSE, SAGE_RESULT_FIELD_TOTAL_COPIES },
	{ TAECHANG_UI_ESTIMATE_COL_COVER, SAGE_COLUMN_ALIGN_RIGHT, TAECHANG_ESTIMATE_COVER_WIDTH, FALSE, SAGE_RESULT_FIELD_VALUE },
	{ TAECHANG_UI_ESTIMATE_COL_FREIGHT, SAGE_COLUMN_ALIGN_RIGHT, TAECHANG_ESTIMATE_FREIGHT_WIDTH, FALSE, SAGE_RESULT_FIELD_REASON }
};
