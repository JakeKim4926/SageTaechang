...
const SageWorkflowColumn g_inputColumns[] = {
	{ TAECHANG_UI_DELIVERY_COL_ROW, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_ROW_WIDTH, FALSE, SAGE_RESULT_FIELD_FIELD },
	{ TAECHANG_UI_DELIVERY_COL_COMPANY, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_COMPANY_WIDTH, FALSE, SAGE_RESULT_FIELD_COMPANY_NAME },
	{ TAECHANG_UI_DELIVERY_COL_DEPARTMENT, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_DEPARTMENT_WIDTH, FALSE, SAGE_RESULT_FIELD_DEPARTMENT },
	{ TAECHANG_UI_DELIVERY_COL_ORDER_DATE, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_DATE_WIDTH, FALSE, SAGE_RESULT_FIELD_ORDER_DATE },
	{ TAECHANG_UI_DELIVERY_COL_DELIVERY_DATE, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_DATE_WIDTH, FALSE, SAGE_RESULT_FIELD_DELIVERY_DATE },
	{ TAECHANG_UI_DELIVERY_COL_DELIVERY_TIME, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_TIME_WIDTH, FALSE, SAGE_RESULT_FIELD_DELIVERY_TIME },
	{ TAECHANG_UI_DELIVERY_COL_ITEM, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_ITEM_WIDTH, FALSE, SAGE_RESULT_FIELD_ITEM_NAME },
	{ TAECHANG_UI_DELIVERY_COL_PRODUCT_TYPE, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_TYPE_WIDTH, FALSE, SAGE_RESULT_FIELD_PRODUCT_TYPE },
	{ TAECHANG_UI_DELIVERY_COL_COMPANY_COPIES, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_COPIES_WIDTH, FALSE, SAGE_RESULT_FIELD_COMPANY_COPIES },
	{ TAECHANG_UI_DELIVERY_COL_CORPORATION_COPIES, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_COPIES_WIDTH, FALSE, SAGE_RESULT_FIELD_CORPORATION_COPIES },
	{ TAECHANG_UI_DELIVERY_COL_TOTAL_COPIES, SAGE_COLUMN_ALIGN_CENTER, TAECHANG_DELIVERY_COPIES_WIDTH, FALSE, SAGE_RESULT_FIELD_TOTAL_COPIES }
};
