...
SagePriceRepository::SagePriceRepository(SqlContext* pSqlContext) {
    m_pSqlContext = pSqlContext;
}

SagePriceRepository::~SagePriceRepository() {}

BOOL SagePriceRepository::Insert(const SagePriceDto& dto, int& nNewPriceId, CString& strError) {
    sqlite3* pDb;
...
BOOL SagePriceRepository::SelectByCompany(
...
BOOL SagePriceRepository::SelectByCompanyAndCopies(
    const CString& strCompanyName,
    int nReportType,
    int nCopies,
    SagePriceDto& dto,
...
BOOL SagePriceRepository::SelectByPrice(
    int nPrice,
    int nReportType,
    CArray<SagePriceDto, SagePriceDto&>& arrPrice,
    CString& strError
...
BOOL SagePriceRepository::UpdatePriceByCompany(
    const CString& strCompanyName,
    int nReportType,
    int nPrintPrice,
    int nCoverPrice,
...
BOOL SagePriceRepository::UpdatePriceByCompanyAndCopies(
    const CString& strCompanyName,
    int nReportType,
    int nCopies,
    int nPrintPrice,
...
BOOL SagePriceRepository::UpdateCompanyName(
...
BOOL SagePriceRepository::UpdateCoverPriceByCompany(
    const CString& strCompanyName,
    int nReportType,
    int nCoverPrice,
    int& nAffectedCount,
...
BOOL SagePriceRepository::ExistsOverlap(
    const CString& strCompanyName,
    int nReportType,
    int nMinCopies,
    BOOL bHasMaxCopies,
...
BOOL SagePriceRepository::DeleteByPriceId(int nPriceId, CString& strError) {
    sqlite3* pDb;
    sqlite3_stmt* pStatement;
    int nResult;
    ...
    nResult = sqlite3_prepare_v2(
        pDb,
        "DELETE FROM SagePrice WHERE price_id = ?;",
        -1, &pStatement, NULL
    );
...
BOOL SagePriceRepository::DeleteByCompany(
    const CString& strCompanyName,
    int nReportType,
    int& nAffectedCount,
    CString& strError
...
BOOL SagePriceRepository::ExecuteCompanyStatement(
    ...
    if (m_pSqlContext == NULL || m_pSqlContext->IsOpened() == FALSE) {
        strError = SAGE_DB_NOT_OPENED_MESSAGE;
        return FALSE;
    }
...
BOOL SagePriceRepository::InsertCompany(
    const CString& strCompanyName,
    int nReportType,
    int& nNewCompanyId,
    CString& strError
    ...
    strSqlA =
        "INSERT INTO SagePriceCompany (company_name, report_type) "
        "VALUES (?, ?);";
...
BOOL SagePriceRepository::SelectAllCompanyNames(
    int nReportType,
    ...
    strSqlA =
        "SELECT company_name FROM SagePriceCompany WHERE report_type = ? "
        "UNION "
        "SELECT company_name FROM SagePrice WHERE report_type = ? "
...
BOOL SagePriceRepository::UpdateByPriceId(
    int nPriceId,
    int nMinCopies,
    BOOL bHasMaxCopies,
    int nMaxCopies,
...
BOOL SagePriceRepository::FillDto(sqlite3_stmt* pStatement, SagePriceDto& dto) {
